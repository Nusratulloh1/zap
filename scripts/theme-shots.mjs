// Скриншот-сет всех экранов для темизации (THEME=light|dark, SHOT_DIR обязателен).
// Детерминизм: автоплей карусели выключен (zap:test), CSS-анимации заморожены, каретка скрыта.
