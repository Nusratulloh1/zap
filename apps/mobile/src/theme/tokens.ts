...
export const palette = {
  light: {
    ...
    /*
      Главное действие: чернильная плашка с лаймовой надписью. В тёмной теме
      пара переворачивается — иначе colors.ink светлеет, и лайм на нём
      исчезает (так пропадали «Напомнить всем», «Сплитить здесь», «владелец»).
    */
    ctaBg: '#121212',
    ctaFg: '#D9FF3A',
    shell: '#F1EFE9',
