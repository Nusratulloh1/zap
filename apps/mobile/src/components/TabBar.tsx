  ...
  */
  ...
  return (
    <View pointerEvents="box-none" style={[styles.wrap, { paddingBottom: Math.min(insets.bottom, 20) + 10 }]}>
      ...
      */}
      {/*
        В тёмной теме поверхность пилла — та же, что у кнопок шапки главной
        (#252523: чернила плюс белые 8%), но блюр под ней остаётся: с ним
        стекло живое на краях, а тон совпадает с кнопкой.
      */}
      <Glass
        thin
        dark={dark}
