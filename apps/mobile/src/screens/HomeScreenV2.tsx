...
/*
  Сколько событий ленты показываем за раз. Три — ровно столько, чтобы лента
  читалась как лента, но не отодвигала всё, что под ней; остальное
  подгружается прокруткой.
*/
const FEED_PAGE = 3;
