...
/*
  Набор реакций. Первые пять — из макета (❤️ 🔥 👏 😂 ⚡), последние две
  остались от прошлой палитры: они уже лежат в базе у старых сплитов, и
  выкидывать их из белого списка нельзя — иначе повтор тапа по своей же старой
  реакции упрётся в 400.
*/
