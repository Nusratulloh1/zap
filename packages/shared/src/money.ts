// Денежные и телефонные утилиты. Чистые функции без i18n — поэтому годятся
// и вебу, и RN. Всё, что зависит от локали (склонения, даты), живёт в клиентах.
...
/** Равные доли, округлённые до 1 000 UZS; остаток уходит первым участникам. */
